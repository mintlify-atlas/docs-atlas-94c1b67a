---
title: "Event Callbacks & Input Polling API Reference — LWXGL"
sidebarTitle: "Events & Input"
description: "Reference for LWXGL event callbacks (key, click, window-close) and input polling functions (mouse position, keyboard state, key constants)."
---

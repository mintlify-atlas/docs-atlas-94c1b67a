---
title: "Install LWXGL on Linux from Source"
sidebarTitle: "Installation"
description: "Build libLWXGL.so from source with make and install the shared library and header system-wide in two commands."
---

---
title: "Window Lifecycle in LWXGL: Create, Loop, and Destroy"
...
You can also close the window at any time by pressing <kbd>Ctrl</kbd>+<kbd>Escape</kbd>, which calls `GDeleteWindow()` — invoking the registered delete callback if one is attached.
